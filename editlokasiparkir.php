  ...
  <body>
                      <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form class="user">
												<form class="form-horizontal" action="updatelokasiparkir.php" method="post">
                                <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="IDLokasi"
                                            placeholder="ID Lokasi" value="<?php echo $IDLokasi;?>" readonly="yes" name="IDLokasi">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="NamaLokasi"
                                            placeholder="Nama Lokasi" value="<?php echo $NamaLokasi;?>" name="NamaLokasi">
                                    </div>
                                </div>
