                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                INPUT</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">TAMBAH STAF</div>
                                        </div>
                                        <div class="col-auto">
...
if ($IDStaf === null) {
    ?>
    <form method="post" action="createstaf.php">
    <?php
    $IDStaf = '';
    $NamaStaf = '';
    $Alamat = '';
                      ...
                      <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="IDStaf"
                                            placeholder="ID Staf" value="<?php echo $IDStaf;?>" name="IDStaf">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
									<select class="form-control form-control-user" name ="Posisi" for="Posisi" id="Posisi" >
