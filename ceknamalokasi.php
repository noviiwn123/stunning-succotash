...
<head>
    ...
    <title>E-Parking - Cek Lokasi Parkir</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                         <a class="btn btn-primary" style="margin-left:0px; width: 150px"href="Lokasi_A.php">Lokasi A</a> 						 
						 <a class="btn btn-danger" style="margin-left:100px; width: 150px" href="Lokasi_B.php">Lokasi B</a>
						 <a class="btn btn-success" style="margin-left:100px; width: 150px" href="Lokasi_C.php">Lokasi C</a>
						 <a class="btn btn-dark" style="margin-left:100px; width: 150px" href="Lokasi_D.php">Lokasi D</a>
						 <a class="btn btn-warning" style="margin-left:100px; width: 150px" href="Lokasi_E.php">Lokasi E</a>
                            </div>
							<marquee><h4> *Pilih Lokasi yang ingin dicek ! </h4></marquee>
                        </div>
						<a rel="nofollow" href="inputlokasiparkir.php">&rarr; Kembali </a>
                    </div>
</div>
                </div>
                <!-- /.container-fluid -->
