...
<head>
    ...
    <title>E-Parking - Kendaraan</title>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                INPUT</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">TAMBAH KENDARAAN</div>
                                        </div>
                                        <div class="col-auto">
...
if ($IDKendaraan === null) {
    ?>
    <form method="post" action="createkendaraan.php">
    <?php
    $IDKendaraan = '';
    $NamaStaf = '';
    $Alamat = '';
    ...
    ?>
    <form method="post" action="updatekendaraan.php">
    <input type="hidden" name="IDKendaraan" value="<?php echo $IDKendaraan;?>">
    <?php

    $sql = "SELECT * FROM kendaraan WHERE IDKendaraan=$IDKendaraan";
                            ...
                            <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="IDKendaraan"
                                            placeholder="ID Kendaraan" value="<?php echo $IDKendaraan;?>" name="IDKendaraan">
                                    </div>
								</div>
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="Keterangan"
                                            placeholder="Keterangan" value="<?php echo $Keterangan;?>" name="Keterangan">
                                    </div>
                                </div>
								<button class="btn btn-primary" id="submit" name="submit">Tambah</button>
												<a class="btn btn-primary" href="datasama.php">CEK DATA SAMA</a>
                            </div>
                        </div>
																<a rel="nofollow" href="kendaraan.php">&rarr; Kembali </a>
                    </div>
					</div>
                <!-- /.container-fluid -->
