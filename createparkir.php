<?php
include 'conn.php';
		if(empty($_POST['IDParkir']) || empty($_POST['TglParkir']) || empty($_POST['JamMasuk']) || empty($_POST['JamKeluar']) || empty($_POST['JenisKendaraan']))
		{
...
if ($JenisKendaraan =='Motor'){
	...
	$Biaya = $hours*4000;
		...
		$sql = "INSERT INTO parkir (IDParkir,TglParkir, JamMasuk, JamKeluar, JenisKendaraan, Biaya) VALUES ('$IDParkir','$TglParkir', '$JamMasuk', '$JamKeluar', '$JenisKendaraan', '$Biaya' )";
