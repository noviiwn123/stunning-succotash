                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                EDIT</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">EDIT KENDARAAN</div>
                                        </div>
                                        <div class="col-auto">
...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form class="user">
												<form class="form-horizontal" action="updatekendaraan.php" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="IDKendaraan"
                                            placeholder="ID Kendaraan" value="<?php echo $IDKendaraan;?>" readonly required="required" name="IDKendaraan">
                                    </div>
								</div>
