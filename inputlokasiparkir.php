...
<head>
    ...
    <title>E-Parking - Lokasi Parkir</title>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                INPUT</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">TAMBAH LOKASI PARKIR</div>
                                        </div>
                                        <div class="col-auto">
...
$IDLokasi = isset($_GET['IDLokasi'])? $_GET['IDLokasi'] : null;

if ($IDLokasi === null) {
    ?>
    <form method="post" action="createlokasiparkir.php">
    <?php
    $IDLokasi = '';
    $NamaLokasi = '';
    $Status = '';
    ...
    ?>
    <form method="post" action="updatelokasiparkir.php">
    <input type="hidden" name="IDLokasi" value="<?php echo $IDLokasi;?>">
    <?php

    $sql = "SELECT * FROM lokasiparkir WHERE IDLokasi=$IDLokasi";
                            ...
                            <form class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="IDLokasi"
                                            placeholder="ID Lokasi" value="<?php echo $IDLokasi;?>" name="IDLokasi">
                                    </div>
                                                                    <div class="form-group">
									<select class="form-control form-control-user" name ="NamaLokasi" for="NamaLokasi" id="NamaLokasi">
									  <option selected></option>
									  <option value="LokasiA">Lokasi A</option>
									  <option value="LokasiB">Lokasi B</option>
									  <option value="LokasiC">Lokasi C</option>
									  <option value="LokasiD">Lokasi D</option>
									  <option value="LokasiE">Lokasi E</option>		
									</select>									  
                                    </div>
                                </div>
                                <div class="form-group">
									<select class="form-control form-control-user" name ="Status" for="Status" id="Status">
									  <option selected></option>
									  <option value="Tersedia">Tersedia</option>								
									</select>
                                    </div>
                                <div class="form-group">
									<select class="form-control form-control-user" name ="Keterangan" for="Keterangan" id="Keterangan">
									  <option selected></option>
								...
								<a class="btn btn-primary" href="ceknamalokasi.php">CEK Lokasi Parkir</a>
                            </div>
                        </div>
                    </div>
<a rel="nofollow" href="lokasiparkir.php">&rarr; Kembali </a>
                </div>
                <!-- /.container-fluid -->
